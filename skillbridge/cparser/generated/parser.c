...
#line 67 "generated/parser.c" /* yacc.c:339  */
...
{
  "$end", "error", "$undefined", "Nil", "True", "String", "Integer",
  "Double", "Symbol", "Id", "'('", "')'", "$accept", "start", "expression",
  "$@1", "non_empty_list", "properties", "$@2", "$@3", "list", YY_NULLPTR
};
#endif
...
do                                                              \
  if (yychar == YYEMPTY)                                        \
    ...
    {                                                           \
      yyerror (scanner, top, path, replicator, YY_("syntax error: cannot back up")); \
      YYERROR;                                                  \
    }                                                           \
while (0)
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Type, Value, scanner, top, path, replicator); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, yyscan_t scanner, PyObject** top, PyObject* path, PyObject* replicator)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (scanner);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, yyscan_t scanner, PyObject** top, PyObject* path, PyObject* replicator)
{
  YYFPRINTF (yyoutput, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyoutput, yytype, yyvaluep, scanner, top, path, replicator);
  YYFPRINTF (yyoutput, ")");
}
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, yyscan_t scanner, PyObject** top, PyObject* path, PyObject* replicator)
{
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, scanner, top, path, replicator); \
} while (0)
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, yyscan_t scanner, PyObject** top, PyObject* path, PyObject* replicator)
{
  YYUSE (yyvaluep);
  YYUSE (scanner);
  YYUSE (top);
...
int
yyparse (yyscan_t scanner, PyObject** top, PyObject* path, PyObject* replicator)
{
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (scanner, top, path, replicator, YY_("syntax error"));
#else
# define YYSYNTAX_ERROR yysyntax_error (&yymsg_alloc, &yymsg, \
                                        yyssp, yytoken)
      {
        ...
        yyerror (scanner, top, path, replicator, yymsgp);
      ...
      if (yychar <= YYEOF)
      ...
      else
        {
          yydestruct ("Error: discarding",
                      yytoken, &yylval, scanner, top, path, replicator);
          yychar = YYEMPTY;
        }
    }
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, scanner, top, path, replicator);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (scanner, top, path, replicator, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  yystos[*yyssp], yyvsp, scanner, top, path, replicator);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
